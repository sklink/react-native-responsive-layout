...
var Stack = function (_a) {
    ...
    var eleChildren = arrChildren.reduce(function (result, child, index) {
        result.push(react_1.default.createElement(react_native_1.View, { key: "child-".concat(index), style: stylesheet.child }, child));
        if (divider && index < arrChildren.length - 1) {
            result.push(react_1.default.cloneElement(divider, { key: "separator-".concat(index) }));
        }
        return result;
    }, []);
    return (react_1.default.createElement(react_native_1.View, { style: [styles.root, sx] }, eleChildren));
};
